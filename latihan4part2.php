                ...
                <form action="" method="POST">
                    ...
                    if(isset($_POST['simpan'])){
                        ...
                        public function layang_layang(){
                            ...
                            echo "<tr><td>Rumus Layang-Layang</td> <td>:</td>" . "<td>(Diagonal 1 x Diagonal 2) / 2</td>" ."</tr>";
                            echo "<tr><td>D1 Layang-Layangt</td> <td>:</td>" . "<td>$this->bil1</td>" ."</tr>";
                            echo "<tr><td>D2 Layang-Layang</td> <td>:</td>" . "<td>$this->bil2</td>" ."</tr>";
