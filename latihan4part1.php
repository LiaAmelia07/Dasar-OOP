                ...
                <form action="" method="POST">
                    ...
                    if(isset($_POST['simpan'])){
                        ...
                        public function jajar_genjang(){
                            ...
                            echo "<tr><td>Rumus jajar genjang</td> <td>:</td>" . "<td>Alas x Tinggi</td>" ."</tr>";
                            echo "<tr><td>Alas jajar genjang</td> <td>:</td>" . "<td>$this->bil1</td>" ."</tr>";
                            echo "<tr><td>Tinggi jajar genjang</td> <td>:</td>" . "<td>$this->bil2</td>" ."</tr>";
